<section class="relative" aria-label="Titelbild">
  <picture>
    <source
      type="image/avif"
      srcset="/img/senntiefbau-visual-480w.avif 480w, /img/senntiefbau-visual-768w.avif 768w, /img/senntiefbau-visual-1024w.avif 1024w, /img/senntiefbau-visual-1440w.avif 1440w"
      sizes="100vw" />
    <source
      type="image/webp"
      srcset="/img/senntiefbau-visual-480w.webp 480w, /img/senntiefbau-visual-768w.webp 768w, /img/senntiefbau-visual-1024w.webp 1024w, /img/senntiefbau-visual-1440w.webp 1440w"
      sizes="100vw" />
    <source
      type="image/jpeg"
