<div class="bg-teal px-40 pt-30 pb-40 lg:pt-60 lg:pb-80">
  ...
  <x-layout.container class="text-white">
    ...
    <x-headings.h2 class="md:text-center">
      Arbeit im Tiefgang
    </x-headings.h2>

    <p class="md:text-center max-w-prose mx-auto">
    ...
    <div class="flex flex-col gap-y-65 md:grid md:grid-cols-2 xl:grid-cols-4 md:gap-x-40 md:gap-y-80 mt-90">
      ...
      <x-cards.service icon="excavator">
        <x-slot:title>
          Rückbau / Aushub
        </x-slot:title>
        <x-slot:text>
      ...
      <x-cards.service icon="brickwall">
        <x-slot:title>
          Umgebungsarbeiten
        </x-slot:title>
        <x-slot:text>
